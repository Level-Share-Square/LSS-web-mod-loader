...
document.getElementById("openManagerButton").addEventListener("click", () => {
  extension.windows.create(
    {
      url: extension.runtime.getURL("popup/manager/popup.html"),
      type: "popup",
    ...
    (win) => {
      if (extensionAPI.runtime.lastError) {
        console.error("Error creating window:", extensionAPI.runtime.lastError);
      } else {
        console.log("Manager opened successfully:", win);
      }
    }
  );
  window.close();
